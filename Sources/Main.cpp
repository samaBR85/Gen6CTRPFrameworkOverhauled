...
namespace CTRPluginFramework {
    ...
    */
    ...
    void InitMenu(PluginMenu &menu) {
        ...
        *movement += Fav(new MenuEntry(getLanguage->Get("MISC_ACCESS_FLY_MAP"), FlyMapInSummary, getLanguage->Get("NOTE_MISC_ACCESS_FLY_MAP")), "FAV_MISC_ACCESS_FLY_MAP"); // <W, tested: O3DS/O2DS - Y/OR
        ...
        MenuFolder *breeding = new MenuFolder(getLanguage->Get("MENU_BREEDING"), getLanguage->Get("NOTE_BREEDING"), {
            ...
            Fav(new MenuEntry(getLanguage->Get("MENU_BREEDING_CHECKER"), nullptr, PKHeX::BreedingCompatibility, getLanguage->Get("NOTE_BREEDING_CHECKER")), "FAV_BREEDING_CHECKER")
        });
    ...
    int main(void) {
        ...
        SetLanguage(false);
        PluginMenu *menu = new PluginMenu("Gen6CTRPFramework Overhauled", 0, 8, 3, getLanguage->Get("FW_ABOUT_BODY"));
